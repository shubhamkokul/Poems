...
def read_csv(input_user):
    ...
    sublimits = []
    poems_count = []
    input_data = pd.read_csv("/home/5pk/PycharmProjects/Poems/data/input/{}.txt".format(input_user))
    poet = input_data.iloc[0].iloc[1]
    print('Poet {}'.format(poet.strip()))
    os.mkdir('/home/5pk/PycharmProjects/Poems/data/{}/'.format(poet.strip()))
    ...
    for a in range(len(links)):
        os.mkdir('/home/5pk/PycharmProjects/Poems/data/{}/{}'.format(poet.strip(), sublimits[a]))
        if (poems_count[a] > 0):
...
def clear_poems(data1, data2, data3):
    ...
    c = 0
    f = open("/home/5pk/PycharmProjects/Poems/data/{}/{}/{}.txt".format(data1, data2, data3), "a")
...
def final_call():
    input_data = pd.read_csv("/home/5pk/PycharmProjects/Poems/data/names.txt")
